...
#Region "Methods"
        ...
        ''' <returns>if the operation was successful</returns>
        Function CreateTableOnDatabase(pDatabaseName As String, pTableName As String, pColumns As List(Of DataColumn)) As Boolean
        ...
        Function UpdateInsertTableData(pDatabaseName As String, pDataTable As DataTable) As Integer
#End Region
    End Interface
End Namespace